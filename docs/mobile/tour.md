...
![Opening Cyd for the first time](./img/tour-onboarding.png)
...
![Opening Cyd for the first time](./img/tour-add-account.png)
...
![Authorize Cyd to access your Bluesky account](./img/tour-authorize.png)

### Features

When you select a Bluesky account, you'll see the the following page:

![Cyd's home page](./img/tour-home.png)
